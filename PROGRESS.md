...
I noticed that, since the list of synonyms is a dictionary, sometimes a key wrongly gets overwritten, such as {stir: shake}. It is desirable to have such a word link to its original state, such that {stir: stir}.  I fixed this by checking if there is already an occurrence of {word: word}, before appending {synonym: word} so that it now links correctly when retrieving a key. I also focused a lot of my time today on writing my thesis and I integrated some of the feedback I was given for the Academic English assignments (I still have to finish doing this).

## Wednesday 14/06/2017, Thursday 15/06/2017, Monday 19/06/2017
